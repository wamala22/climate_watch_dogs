    ...
    public function index() {
        ...
        foreach (ORM::factory('category')
            ...
            foreach ($category->orderby('category_position', 'asc')->children as $child) {
                ...
                if ($child->category_trusted) { // Get Trusted Category Count
        ...
        $this->themes->js->marker_opacity =
                ($marker_opacity >= 1 && $marker_opacity <= 10 ) ? $marker_opacity * 0.1 : 0.9;
        ...
        $this->themes->js->marker_stroke_opacity =
                ($marker_stroke_opacity >= 1 && $marker_stroke_opacity <= 10 ) ? $marker_stroke_opacity * 0.1 : 0.9;
