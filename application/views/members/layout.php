    ...
    <body>
        <div class="holder">
            ...
            <div id="header">
                ...
                <div class="top">
                    <ul>
                        <li class="none-separator"> <?php echo Kohana::lang('ui_admin.welcome');
echo $admin_name; ?>!</li>
...
<?php foreach ($main_tabs as $page => $tab_name) { ?>
                            <li><a href="<?php echo url::site(); ?>members/<?php echo $page; ?>" <?php if ($this_page == $page)
        echo 'class="active"'; ?>><?php echo $tab_name; ?></a></li>
<?php } ?>
                    </ul>
                </div>
            </div>
