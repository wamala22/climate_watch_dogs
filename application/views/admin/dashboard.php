    ...
    <div class="column">
        ...
        <div class="info-container">
            ...
            foreach ($incidents as $incident) {
                ...
                $incident_remarks = text::limit_chars(strip_tags($incident->incident_remarks), 150, '...');
                ...
                <div class="post">
                    ...
                    <h4><strong><?php echo $incident_date; ?></strong><a href="<?php echo url::site() . 'admin/reports/edit/' . $incident_id; ?>"><?php echo $incident_NoOfTrees; ?></a></h4>
                    <p><?php echo $incident_remarks; ?></p>
                </div>
                <?php
            }
            ?>
