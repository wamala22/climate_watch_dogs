    ...
    <div class="report-form">
        ...
        <div class="f-col">
            ...
            <div class="row">
                ...
                <?php print form::textarea('incident_remarks', $form['incident_remarks'], ' rows="12" cols="40"') ?>
            </div>
...
// Action::report_form_admin - Runs just after the report description
            ...
            <?php
            if (!($id)) { // Use default date for new report
                ?>
            ...
            ?>
            <div class="row <?php
            if (!($id)) { // Hide date editor for new report
                echo "hide";
            }
            ?> " id="datetime_edit">
                <div class="date-box">
                ...
                <div class="time">
                    ...
                    print '<span class="sel-holder">' .
                            form::dropdown('incident_hour', $hour_array, $form['incident_hour']) . '</span>';

                    print '<span class="dots">:</span>';

                    print '<span class="sel-holder">' .
                            form::dropdown('incident_minute', $minute_array, $form['incident_minute']) .
                            '</span>';
                    print '<span class="dots">:</span>';

                    print '<span class="sel-holder">' .
                            form::dropdown('incident_ampm', $ampm_array, $form['incident_ampm']) . '</span>';
                    ?>
                </div>
            </div>
            ...
            <div class="row">
                <h4><?php echo Kohana::lang('ui_main.treeNo'); ?></h4>
                <div class="report_category" id="categories">
                    <?php echo form::radio('No_of_trees', '( 1 - 10 )', TRUE); ?>( 1 - 10 ) trees<br /><br />
                    <?php echo form::radio('No_of_trees', '( 10 - 50 )', FALSE); ?> ( 10 - 50 ) trees<br /><br />
                    <?php echo form::radio('No_of_trees', '( 50 - 100 )', FALSE); ?> ( 50 - 100 ) trees<br /><br />
                    <?php echo form::radio('No_of_trees', '( 100 - 500 )', FALSE); ?> ( 100 - 500 ) trees<br /><br />
                    <?php echo form::radio('No_of_trees', '( Over 500 )', FALSE); ?> ( Over 500 ) trees<br />
        ...
        <div class="f-col-bottom-container">
            <div class="f-col-bottom">
                <div class="row">
                    ...
                    <label>
                        ...
                        <?php print form::input('person_fullName', $form['person_fullName'], ' class="text"'); ?>
                    </label>
                </div>
                <div class="row">
                    <label>
                        <span><?php echo Kohana::lang('ui_main.email_address'); ?></span>
                        <?php print form::input('person_contacts', $form['person_contacts'], ' class="text"'); ?>
                    </label>
                </div>
            </div>
            <!-- f-col-bottom-1 -->
            <div class="f-col-bottom-1">
                ...
                <div class="row">
                    ...
                    <?php
                    if ($form['incident_verified'] == 1) {
                        echo " checked=\"checked\" ";
                    }
                    ?>> <?php echo Kohana::lang('ui_main.yes'); ?>
                    <input type="radio" name="incident_verified" value="0"
                    <?php
                    if ($form['incident_verified'] == 0) {
                        echo " checked=\"checked\" ";
                    }
                    ?>> <?php echo Kohana::lang('ui_main.no'); ?>									
                </div>
                <div class="row">
                    ...
                    <?php
                    print form::dropdown('incident_source', array("" => Kohana::lang('ui_main.report_edit_dropdown_1_default'),
                ...
                <div class="row">
                    ...
                    <?php
                    print form::dropdown('incident_information', array("" => Kohana::lang('ui_main.report_edit_dropdown_1_default'),
