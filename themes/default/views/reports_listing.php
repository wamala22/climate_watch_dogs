...
<div class="rb_list-and-map-box">
    <div id="rb_list-view">
        ...
        foreach ($incidents as $incident) {
            ...
            $incident_NoOfTrees = $incident->incident_NoOfTrees;
            $incident_remarks = $incident->incident_remarks;
            //$incident_category = $incident->incident_category;
            // Trim to 150 characters without cutting words
            // XXX: Perhaps delcare 150 as constant

            $incident_remarks = text::limit_chars(strip_tags($incident_remarks), 140, "...", true);
            ...
            $kimCategory = $incident->category;
            if ($kimCategory[0]->category_title == 'Trees planted') {
                $incident_thumb = url::file_loc('img') . "media/img/afforestation.jpg";
            }if ($kimCategory[0]->category_title == 'Trees cut') {
                $incident_thumb = url::file_loc('img') . "media/img/deforestation.jpg";
            }
                ...
                <div class="r_media">
                    ...
                    <div class="r_categories">
                        ...
                        <?php foreach ($incident->category as $category): ?>
                            ...
                            $incident_category = $category->category_title;
                            // Don't show hidden categories  
                            ?>
                            <?php if ($category->category_visible == 0)
                                continue; ?>
    ...
    <?php echo $incident_category; ?><?php echo $incident_NoOfTrees; ?>
                        </a>
    ...
    <?php echo $incident_verified; ?>
                    ...
                    <div class="r_description"> <?php echo $incident_remarks; ?>  
