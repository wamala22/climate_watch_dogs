        ...
        <div class="big-block">
            ...
            <div class="report_left">
                ...
                <div class="report_row">
                    ...
                    <div class="report_category" id="categories">
                        <?php echo form::radio('incident_NoOfTrees', '( 1 - 10 )', TRUE); ?>( 1 - 10 ) trees<br /><br />
                        <?php echo form::radio('incident_NoOfTrees', '( 10 - 50 )', FALSE); ?> ( 10 - 50 ) trees<br /><br />
                        <?php echo form::radio('incident_NoOfTrees', '( 50 - 100 )', FALSE); ?> ( 50 - 100 ) trees<br /><br />
                        <?php echo form::radio('incident_NoOfTrees', '( 100 - 500 )', FALSE); ?> ( 100 - 500 ) trees<br /><br />
                        <?php echo form::radio('incident_NoOfTrees', '( Over 500 )', FALSE); ?> ( Over 500 ) trees<br />
                ...
                <h4><?php echo Kohana::lang('ui_main.description'); ?> </h4>
                    <?php print form::textarea('incident_remarks', $form['incident_remarks'], ' rows="3" class="textarea long" ') ?>
                </div>
                ...
                <div class="report_optional">
                    ...
                    <div class="report_row">
                        <h4>Reporter's Full Names</h4>
                        <?php print form::input('person_fullName', $form['person_fullName'], ' class="text long"'); ?>
                    </div>

                    <div class="report_row">
                        <h4>Reporter's Contact Details</h4>
                        <?php print form::input('person_contacts', $form['person_contacts'], ' class="text long"'); ?>
                    </div>
                    <?php
