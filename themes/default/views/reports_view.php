<div id="main" class="report_detail">
	...
	<div class="left-col" style="float:left;width:520px; margin-right:20px">
			...
			<?php
				foreach($incident_category as $category) 
				{
				  ...
				  if ($category->category->category_image_thumb)
					...
					{
					?>
					  <a href="<?php echo url::site()."reports/?c=".$category->category->id; ?>"><span class="r_cat-box" style="background-color:#<?php echo $category->category->category_color; ?>">&nbsp;</span> <?php echo $category->category->category_title; ?>&nbsp;<?php echo $incident_NoOfTrees; ?></a>
				  <?php
				  }
				}
			?>
		...
		<div class="report-description-text">
			<h5><?php echo Kohana::lang('ui_main.description');?></h5>
