...
<script type="text/javascript" src="./media/js/plotkit/Base.js"></script>
<script type="text/javascript" src="./media/js/plotkit/Layout.js"></script>
<script type="text/javascript" src="./media/js/plotkit/Canvas.js"></script>
<script type="text/javascript" src="./media/js/plotkit/SweetCanvas.js"></script>
...
<div id="header">
	<div class="content-wrapper">
			...
			<div id="menu">
				<ul>
					<?php nav::main_tabs($this_page,array('what we do','reports','reports_submit','alerts','contact')); ?>
				</ul>
			</div>
	</div>
</div>
